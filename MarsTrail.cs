    ...
    class ProgramUI
    {
        ...
        public void UFO()
        {
            ...
            if (inspectUFO == "y")
            {
                ...
                if (alienResponse == "i")
                {
                    Console.WriteLine($"You're crew comes under a barrage of heavy fire! \n  You're ship is just able to get away.");
                    Console.WriteLine($"{userNameThree} is mortally wounded.. \n they won't make it through the night.");
                    Console.ReadLine();
                    panicRoom();
                }
